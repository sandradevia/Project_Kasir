...
$dataapa = "Laporan Penjualan"; // data
...
<div class="col-lg-12">
    ...
    <div class="box">
       ...
       <h3 class="box-title">Penjualan <a href="report_trxjual" class="btn btn-sm bg-orange"><i class="fa fa-refresh"></i> Refresh</a></h3>
            ...
            <div class="col-md-6">
                ...
                <table class="table">
                    <tr>
                        ...
                        <td>
                              <select class="form-control select2" style="width: 100%;" name="c" required>
...
$sqla = mysqli_fetch_assoc(mysqli_query($conn,"SELECT SUM(total) as omzet, SUM(keluar) as hpp FROM bayar WHERE tglbayar BETWEEN '" . $s . "' AND  '" . $e . "' ORDER BY no DESC"));
...
?>
               ...
               <tr>
                   <td style="width:20%">Omzet:</td>
                   <td><?php echo number_format($sqla['omzet']);?></td>
               </tr>
                 <tr>
                   <td style="width:20%">Laba:</td>
                   <td><?php echo number_format($sqla['omzet']-$sqla['hpp']);?></td>
               </tr>
               </table>
...
<?php } ?>
        ...
        </div><span>Laba didapat dari selisih Total Penjualan dengan H.P.P(harga pokok penjualan/Harga beli)</span>
    </div>
        ...
        if( isset($c) && $c=='all' ){
             $sql = mysqli_query($conn,"SELECT * FROM bayar WHERE tglbayar BETWEEN '" . $s . "' AND  '" . $e . "' ORDER BY no DESC"); 
        } else if(isset($s)) {  
             $sql = mysqli_query($conn,"SELECT * FROM bayar WHERE customer LIKE '$c' AND tglbayar BETWEEN '" . $s . "' AND  '" . $e . "' ORDER BY no DESC"); 
        } else {
             $sql = mysqli_query($conn,"SELECT * FROM bayar ORDER BY no DESC"); 
        }
  ...
  <tr>
            ...
            <td><?php  echo mysqli_real_escape_string($conn, date('d-m-Y',strtotime($fill['tglbayar']))); ?></td>
            <td><?php  echo mysqli_real_escape_string($conn, $fill['kode']); ?></td>
          
              <td><?php  echo mysqli_real_escape_string($conn, $fill['customer']); ?></td>
