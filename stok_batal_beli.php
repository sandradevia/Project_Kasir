...
$halaman = "stok_batal_beli"; // halaman
$dataapa = "Pembatalan Pembelian"; // data
...
if ($chmod >= 2 || $_SESSION['jabatan'] == 'admin') {
  ...
  <!-- KONTEN BODY AWAL -->
           ...
           $sql    = "select * from transaksibeli where nota ='$q' order by no";

           $sum=mysqli_fetch_assoc(mysqli_query($conn,"SELECT SUM(hargaakhir) as sub FROM transaksibeli WHERE nota='$q'"));
