...
<div class="col-lg-12">
    ...
    <div class="box">
       ...
       <h3 class="box-title">Pembelian <a href="report_trxbeli" class="btn btn-sm bg-orange"><i class="fa fa-refresh"></i> Refresh</a></h3>
            ...
            <div class="col-md-6">
                ...
                <table class="table">
                    <tr>
                        ...
                        <td>
                              <select class="form-control select2" style="width: 100%;" name="v" required>
...
$sqla = mysqli_fetch_assoc(mysqli_query($conn,"SELECT SUM(total) as beli FROM beli WHERE tglbeli BETWEEN '" . $s . "' AND  '" . $e . "' ORDER BY no DESC"));

if($v!='all'){
     $supe=mysqli_fetch_assoc(mysqli_query($conn,"SELECT nama FROM supplier WHERE kode=".$fill['supplier'].""));
     $supplier=$supe['nama'];
...
?>
               ...
               <tr>
                 ...
                 <tr>
                   ...
                   <td><?php echo number_format($sqla['beli']);?></td>
               </tr>
               </table>
...
<?php } ?>
        ...
        if( isset($v) && $v=='all' ){
             $sql = mysqli_query($conn,"SELECT * FROM beli WHERE tglbeli BETWEEN '" . $s . "' AND  '" . $e . "' ORDER BY no DESC"); 
        } else if(isset($s)) {  
             $sql = mysqli_query($conn,"SELECT * FROM beli WHERE supplier='$v' AND tglbeli BETWEEN '" . $s . "' AND  '" . $e . "' ORDER BY no DESC"); 
        } else {
             $sql = mysqli_query($conn,"SELECT * FROM beli ORDER BY no DESC"); 
        }
  ...
  <tr>
            ...
            <td><?php  echo mysqli_real_escape_string($conn, date('d-m-Y',strtotime($fill['tglbeli']))); ?></td>
            <td><?php  echo mysqli_real_escape_string($conn, $fill['nota']); ?></td>
            <?php $sup=mysqli_fetch_assoc(mysqli_query($conn,"SELECT nama FROM supplier WHERE kode=".$fill['supplier'].""));?>
              <td><?php  echo mysqli_real_escape_string($conn, $sup['nama']); ?></td>
