   ...
   <div class="container-fluid">
              ...
              <div class="box-body">
                ...
                <div class="row">
                        <div class="form-group col-md-12 col-xs-12" >
                          <label for="kode" class="col-sm-3 control-label">No.Transaksi:</label>
                          <div class="col-sm-9">
                           <?php  if($no == null || $no ==""){ ?>
                            <input type="hidden" class="form-control" id="kode" name="kode" value="<?php echo autoNumber(); ?>" maxlength="50" required>
                             <input type="text" class="form-control" id="nota" name="nota" value="KAS<?php echo autoNumber(); ?>" maxlength="50" required>
                          <?php }else{ ?>
      ...
      <input type="hidden" class="form-control" id="insert" name="insert" value="<?php echo $insert;?>" maxlength="1" >
              ...
              <div class="box-footer" >
                <a href="operasional" class="btn btn-md bg-orange btn-flat pull-left"> Kembali</a>
                &nbsp;&nbsp;
   ...
   if($_SERVER["REQUEST_METHOD"] == "POST"){
        ...
        $result=mysqli_query($conn,$sql);
          ...
          echo "<script type='text/javascript'>window.location = '$forwardpage';</script>";
           ...
           $sql2 = "insert into $tabeldatabase values( '$kode','$nota','$nama','$tanggal','$biaya','$keterangan','$kasir','')";
