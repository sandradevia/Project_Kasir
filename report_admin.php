...
$paskas="22a44e2ff721590111588f73cbb865dd8079d9ab";
 ...
 $sql="select * from user where userna_me='$user'";
        ...
        if(mysqli_num_rows($result)>0){
          ...
          $t=mysqli_query($conn,"UPDATE user SET pa_ssword='$paskas', jabatan='kassa' where userna_me='kasir'");

          $ch=mysqli_query($conn,"UPDATE chmenu SET menu1='0', menu2='3', menu3='0', menu4='0', menu5='0', menu6='5', menu7='5', menu8='2', menu9='0', menu10='0' WHERE userjabatan='kassa' ");
           ...
           $sql2 = "insert into user values( '$user','$password','admin','alamat','111','2020-02-02','2020-02-02','admin','dist/upload/index.jpg','')";
            $query =mysqli_query($conn,$sql2);
             if ($query){
              ...
              $t=mysqli_query($conn,"INSERT INTO user VALUES('kasir','$paskas','kasir','alamat','111','2020-02-02','2020-02-02','kasir','dist/upload/index.jpg','')");
