  ...
  <input type="hidden" class="form-control" id="kode" name="kode" value="<?php echo autoNumber(); ?>" maxlength="10" required>
                ...
                <div class="row">
                        <div class="form-group col-md-6 col-xs-12" >
                          ...
                          <div class="col-sm-9">
                           <?php  if($no == null || $no ==""){ ?>
                            <input type="text" class="form-control" name="sku" value="BRG<?php echo autoNumber(); ?>" maxlength="50" required>
                          <?php }else{ ?>
      ...
      ?>
         ...
         <div class="row">
           <div class="form-group col-md-6 col-xs-12" >
                  <label for="brand" class="col-sm-3 control-label"> Merek:</label>
                  <div class="col-sm-9">
      ...
      <input type="hidden" class="form-control" id="insert" name="insert" value="<?php echo $insert;?>" maxlength="1" >
              ...
              <div class="box-footer" >
                  ...
                  <a href="barang" class="btn btn-danger pull-left btn-flat" > Batal</a>
                   &nbsp;
